import { useFormik } from "formik"; // импортируем хук с формиком
...
const Form = () => {
  // создаем хук с настройками
  const formik = useFormik({
    // те инпуты, которые мы будем использовать в форме (обязательно name!!!)
    initialValues: {
      name: "",
      email: "",
      amount: 0,
    ...
    // что мы будем делать, когда форм будет отправляться
